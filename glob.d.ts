...
declare function glob (pattern: string, cb: (err: Error, matches: string[]) => void): void;
declare function glob (pattern: string, options: glob.Options, cb: (err: Error, matches: string[]) => void): void;
